<section class="login-s1 container-fluid d-flex align-items-center bg-secondary py-5 minh-100vh">
    <div class="row mx-0 w-100 pt-5 mt-5">
        <div class="col-11 col-sm-7 col-md-6 col-lg-4 col-xxl-3 mx-auto">
            <div class="card bg-blue opacity-9 border-secondary">
                <div class="card-header border-bottom border-secondary">
                    <h6 class="text-white text-uppercase my-1 text-shadow">
                        Login
                    </h6>
                </div>
                <div class="card-body">
                    <form class="text-start px-3" 
                        ...
                        <div class="w-100 small border-bottom border-secondary">
