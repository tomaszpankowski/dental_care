            ...
            <div class="my-auto w-100">
                <div class="row w-100">
                    <div class="col-xs-12 col-sm-8 col-md-6 offset-sm-2 offset-md-3 text-center">
                        <h3 class="text-center font-header text-info mb-3">Message sent!</h3>
                        <table class="table table-hover border table-info text-start font-menu bg-light opacity-8">
                        ...
                        <a href="contact.html" 
                            class="btn btn-info font-header mt-3">OK</a>
                    </div>
                </div>
            </div>
        </section>
